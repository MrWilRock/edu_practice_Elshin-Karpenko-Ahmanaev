...
Коммутатор 1:
![[Pasted image 20260413172007.png]]
*Создание Vlan 2-4 на rus-nks-sw0*

Коммутатор 2:
![[Pasted image 20260413174734.png]]
...
Коммутатор 1:
![[Pasted image 20260413175429.png]]
*Назначение соответствующих интерфейсов в соответствующие VLAN
на rus-nsk-sw0*

Коммутатор 2:
![[Pasted image 20260413175737.png]]
*Назначение соответствующих интерфейсов в соответствующие VLAN
на rus-nsk-sw1
...
![[Pasted image 20260413182155.png]]
...
![[Pasted image 20260413182421.png]]
...
![[Pasted image 20260415142624.png]]
*Настройка SSHv2 на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1)
![[Pasted image 20260415143128.png]]
...
>![[Pasted image 20260415150450.png]]
...
Коммутатор 1 (rus-nsk-sw0)
![[Pasted image 20260415150959.png]]
...
Коммутатор 1 (rus-nsk-sw0):
![[Pasted image 20260415151413.png]]
...
Коммутатор 1 (rus-nsk-sw0):
![[Pasted image 20260415160907.png]]
*Настройка портов f0/2-4 согласно требованиям на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1):
![[Pasted image 20260415160629.png]]
...
Коммутатор 1 (rus-nsk-sw0)
![[Pasted image 20260415161132.png]]
*Настройка защиты консоли на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1)
![[Pasted image 20260415161407.png]]
*Настройка защиты консоли на rus-nsk-sw0*
...
Коммутатор 1 (rus-nsk-sw0)
![[Pasted image 20260415161824.png]]
*Отключение exec-timeout в консоли и SSH на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1)
![[Pasted image 20260415161942.png]]
...
Коммутатор 1 (rus-nsk-sw0)
![[Pasted image 20260415162127.png]]
*Отключение прерываний консоли на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1)
![[Pasted image 20260415162433.png]]
...
Коммутатор 1 (rus-nsk-sw0)
![[Pasted image 20260415162741.png]]
*Увеличение размер буфера истории до 256 на rus-nsk-sw0*

Коммутатор 2 (rus-nsk-sw1)
![[Pasted image 20260415162816.png]]
*Увеличение размер буфера истории до 256 на rus-nsk-sw0*
...
![[Pasted image 20260415164147.png]]
