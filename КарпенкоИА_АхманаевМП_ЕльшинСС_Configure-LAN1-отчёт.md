...
## Часть 5:
## Шаг 1:
Настроим EIGRP с номером автономной системы (AS) 100 на R1, R2, R3 и MLS

R1 (он же rus-nsk-r0)

![](/IMAGES/Pasted_image_20260420152346.png)

>Поправка: маски /8 для подсетей лучше указать и везде далее лучше добавить подсеть 12.0.0.0/8

*Настройка EIGRP на новосибирском роутере*

R2 (он же rus-msk-r0)

![](/IMAGES/Pasted_image_20260420152456.png)

*Настройка EIGRP на московском роутере 1 (msk-r0)*

R3 (он же rus-msk-r1)

![](/IMAGES/Pasted_image_20260420152702.png)

*Настройка EIGRP на московском роутере 2 (msk-r1)*

MLS

![](/IMAGES/Pasted_image_20260420152738.png)

*Настройка EIGRP на MLS*

---
## Шаг 2:
Проверим, обеспечив возможность подключения по SSH с сервера, подключенного к подсети 10.0.0.0/8 (R2 и R3), к SW1 и SW2

Сначала зададим статический IP-адрес серверу:

![](/IMAGES/Pasted_image_20260420153201.png)

*Установка статического IP серверу в Москве*

Теперь настроим SSH на московском коммутаторе

![](/IMAGES/Pasted_image_20260420160417.png)

*Настройка SSH на rus-msk-sw0*

![](/IMAGES/Pasted_image_20260420172242.png)

*Успешно установленная связь с rus-nsk-sw0*

![](/IMAGES/Pasted_image_20260420172405.png)

*Успешно установленная связь с rus-nsk-sw1*
...
![](/IMAGES/Pasted_image_20260420160900.png)

*Проверка связи с 2.0.0.50*

---
## Часть 6:
## Шаг 1:
Настроим SW21? (у нас будет московский коммутатор) так, чтобы он принимал SSH-соединения только с сервера 10.0.0.100 и ПК 2.0.0.100.

![](/IMAGES/Pasted_image_20260420162606.png)

*Настройка московского коммутатора для SSH-соединения*

>Поправка: ACL-список мешает связи, поэтому мы его отключили. С ним ping-запрос не проходил, т.к по правилам списка он блокировался. А при отключении связь есть.

---
## Шаг 2:
Настроим ПК 2.0.0.100 как единственную машину в VLAN 2, которой разрешен доступ к веб-серверу 10.0.0.100.

R3 (rus-msk-r1)

![](/IMAGES/Pasted_image_20260420183617.png)

*Настройка ACL на rus-msk-r1*

![](/IMAGES/Pasted_image_20260420183658.png)

*Применение списка*

R2 (rus-msk-r0)

![](/IMAGES/Pasted_image_20260420183711.png)

*Настройка списка и применение его на интерфейсе*

Доп. проверка

![](/IMAGES/Pasted_image_20260420174045.png)

*Проверка связи с сервером от PC (2.0.0.100)*

![](/IMAGES/Pasted_image_20260420183923.png)

*Проверка доступа до веб-вервера по HTTP*

---
## Шаг 3:
Настроим R2 и R3 так, чтобы они могли пинговать любые машины, но никогда не отвечали на запросы ping, поступающие от каких-либо машин.

![](/IMAGES/Pasted_image_20260420184232.png)

*Настройка на R2 (rus-msk-r0)*

![](/IMAGES/Pasted_image_20260420184402.png)

*Настройка на R2 (rus-msk-r0)*

![](/IMAGES/Pasted_image_20260420184524.png)

*Проверка пинга с роутера*

![](/IMAGES/Pasted_image_20260420184631.png)

*Проверка пинга на роутер с сервера (должен быть без ответа)*
